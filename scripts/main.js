...
async function getInputValue(){
  ...
  if(value === "manpages"){
    ...
    createText("<a href='https://drive.google.com/file/d/17D5HvEuhsMNE94Pi6sRU9u2pMi218MsC/view?usp=sharing' target='_blank' style='color: #1a32eb; text-decoration: underline;'><i class='fab fa-github white'></i> download my coverletter</a>")
  }
    ...
    createText("<a href='https://drive.google.com/file/d/1-o8tgx2kkj8YuBc253m1C5AYxbtDUvvT/view?usp=sharing' target='_blank' style='color: #1a32eb; text-decoration: underline;'><i class='fab fa-github white'></i> download my resume</a>")
      }
    ...
    trueValue(value);
    createText("<a href='https://drive.google.com/file/d/1wwG-ZzNl2gNbgHzQ4gOHdhjxZPGYquJC/view?usp=sharing' target='_blank' style='color: #1a32eb; text-decoration: underline;'><i class='fab fa-github white'></i> download my unofficial transcript</a>")
    createText("<a href='https://drive.google.com/file/d/1N-ONFoP4iLoUZpT2CPrlkozAXmieYr5y/view?usp=sharing' target='_blank' style='color: #1a32eb; text-decoration: underline;'><i class='fab fa-github white'></i> json essentials certificate</a>")
    createText("<a href='https://drive.google.com/file/d/1A_HIN2iB-K0_ZbH49GhUE8K9G6yU55g4/view?usp=sharing' target='_blank' style='color: #1a32eb; text-decoration: underline;'><i class='fab fa-github white'></i> network forensics certificate</a>")
    createText("<a href='https://drive.google.com/file/d/14D-g6TtnI2A8anmM0xQzjUK6g0V-UA55/view?usp=sharing' target='_blank' style='color: #1a32eb; text-decoration: underline;'><i class='fab fa-github white'></i> advanced scrum certificate</a>")
    createText("<a href='https://drive.google.com/file/d/1qBpCnjltnkxWl3Q79p7SEJUarxuSwlP-/view?usp=sharing' target='_blank' style='color: #1a32eb; text-decoration: underline;'><i class='fab fa-github white'></i> learning splunk certificate</a>")
