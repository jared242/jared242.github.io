...
async function getInputValue(){
  ...
  if(value === "manpages"){
    ...
    trueValue(value);
    createText("<span style='color: #FFD700;'>Jared Stark</span><br>(323) 275-7237  |  jared_stark@icloud.com<br><br><span style='color: #FFD700;'>Education</span><br>Bachelor of Applied Computer Science & Network Security<br>University of Southern Queensland | 2017 - 2023<br><br><span style='color: #FFD700;'>Accomplishments</span><br>- Collaborated to identify and build alerting solutions for major SaaS incidents, aiming to transition from reactive to proactive responses<br>- Produced a complex 1:3:1 CM proposal that was received positively & under consideration<br>- Took initiative & identified case management improvements at NinjaOne that were implemented, resulting in SLA achievement increasing from 82% to 91% <br>- Selected to manage all police communications for 2018 Commonwealth Games<br><br><span style='color: #FFD700;'>Experience<br>Software Support Engineer - Axon Enterprise | Nov 2022 - Current</span><br>- Sought feedback and built inter-organizational relationships to learn from, and teach others<br>- Monitored queue, communicating with clients promptly to resolve issues & improve sentiment<br>- Collaborated effectively across multiple teams to resolve issues or major incidents<br>- Sought opportunities to contribute to solving real problems and add value to the team<br>- Initiated discussions to better support customers with environmental version control and independently devised a solution to present to management<br><br><span style='color: #FFD700;'>Software Support Engineer - NinjaOne | May 2022 - November 2022</span><br>- Resolved tickets for SaaS RMM software, serving 7,000+ customers, achieving 88% CSAT<br>- Evaluated customer issues through root cause and log analysis, reproduction and research<br>- Managed SAML & API issues, Firewall/Antivirus Whitelisting & integration problems<br>- Developed and updated internal procedures and customer knowledge base<br><br><span style='color: #FFD700;'>911 Emergency Communications Dispatcher - Jeffcom 911 | January 2020 - May 2021 <br>    and Queensland Police Service | January 2012 - August 2019</span>-<br>- Developed UI feedback, leading to new functionality and improved usability<br>- Operated CAD dispatch system with speed and accuracy, documenting field activity<br>- Maintained and updated criminal, driver's license and warrant information in law databases<br>- Recognized as SME and selected to manage police communications for 2018 Commonwealth Games<br><br><span style='color: #FFD700;'>Store Manager - Tile City | June 2008 - January 2012</span><br>- Addressed concerns from staff & customers in-line with business processes & policies<br>- Provided exceptional customer experiences, and demonstrated service expectations to employees<br>- Reduced reporting time on productivity, sales & staffing by 60% through process improvements<br>- Increased retention through realistic expectations & recommending people with shared goals<br><br><span style='color: #FFD700;'>Software -</span> VSCode, Slack, Jira, ZenDesk, Azure, O365, SalesForce, Git, Ubuntu/Windows/MacOS<br><br><span style='color: #FFD700;'>Coding -</span> JSON, Python, Bash, PowerShell, C, C#, SQL, html, JavaScript, PHP, jQuery")
    ...
    trueValue(value);
    createText("The major capstone project that I am most proud of, is working in conjunction with Persimmons Australia to enhance their farmer portal. This portal is used by persimmons farmers across the country to submit data relating to the their harvest size, consignment sale prices, packaging, fruit variety and state of origin. This data is then collated into weekly reports and distributed to the participating farmers, to provide better insights, and for the betterment of the farmers and industry as a whole.some of the teams keys achievements during the process were:<br>- Password Complexity enforcement: Requires users' new passwords to be at least 8 characters long, containing numbers and special characters, increasing complexity and making it harder for attackers to crack passwords.<br>- First Time Login password reset: Forces users to change their password on their first login to ensure only the user knows the password, enhancing security.<br>- Password Reset Tool: Allows users to enter their email address, and if it exists in the database, an email is sent containing a message and a link to the change password page. The tool includes a time-limited token, reducing the window for interception by attackers. An external SMTP server is required for production use.<br>- Show/Disable Password ability with eye icon: Users can toggle password visibility using an eye icon, reducing errors and improving usability.\n- Grower Consignment report functionality: Users can add and retrieve reports in the application.<br>- Grower Consignment report review before submit page: Users can review their input on the grower's consignment form before submitting it. Enhances user control, user experience, and may fulfill legal requirements.<br>User Interface update: Refreshed the user interface using CSS stylesheets to create a modern look consistent with the branding of Persimmons Australia INC, incorporating orange and white colors.<br><br>Not only was this a value experience in terms of applying my learned skills, but more importantly, it provided the opportunity to experience what a real-life project is like. We worked remotely from across the world and had to align meeting times between different cities, sates and countries, has to self-regulate our team and ensure we were all responsible for keeping one another accountable, and also got to work collaboratively on a codebase that was shared between all of us. <br><br>I found that emulating a real development team was more challenging that I originally anticipated, however was extremely rewarding and a valuable learning it experience. The main challenges were mostly internal; keeping my work on track, communicating on a regular basis through tools provided, and maintaining a positive culture across a broad geographic distance. I feel as a team we successfully navigated these issue and came out of the other side as strong and competent team members, ready to apply our skills to any new workplace and hit the ground running as valuable team members for any project we participate in.")
  }
